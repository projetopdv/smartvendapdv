  ...
  return (
    ...
    >
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-4 py-8">
        ...
        <div className="grid gap-3 grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 w-full max-w-3xl mt-6">
          {[
            ...
            <button
              key={to}
              onClick={() => navigate({ to })}
              className="flex flex-col items-center justify-center gap-2 rounded-xl bg-white/10 ring-1 ring-white/20 p-4 text-white hover:bg-white/15 transition-all"
            >
        ...
        <div className="mt-8 flex gap-4 text-xs text-white/60">
          <Link to="/termos" className="hover:text-white underline">Termos de Uso</Link>
          <span>•</span>
          <Link to="/privacidade" className="hover:text-white underline">Política de Privacidade</Link>
        </div>
      </main>
    </div>
  );
